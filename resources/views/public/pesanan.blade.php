                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        ...
                                        <span class="badge rounded-pill
                                            {{ $t->status_pembayaran == 'lunas' ? 'bg-success' : ($t->status_pembayaran == 'pending' ? 'bg-warning text-dark' : 'bg-danger') }}">
                                    ...
                                    @if ($t->status_pembayaran == 'pending')
                                        <div class="alert alert-warning small py-2 mt-3 mb-2">
                                            Menunggu pembayaran. Lakukan pembayaran dan konfirmasi ke admin.
                                        </div>
